...
public class Result<V, E extends Exception> {
    ...
    public static <V, E extends Exception> Result<V, E> failure(E error) {
    ...
    public static <E extends Exception> Result<Optional<Object>, E> attempt(CheckedRunnable<? extends E> r) {
        return attempt(() -> {
            r.run();
    ...
    public static <V, E extends Exception> Result<V, E> attempt(CheckedSupplier<? extends V, ? extends E> p) {
    ...
    @SuppressWarnings("unchecked")
    public static <V, E extends Exception> Result<V, E> of(Object o) {
    ...
    public static <T, V, E extends Exception> Function<T, Result<V, E>> from(CheckedFunction<T, V, E> cf) {
     ...
     */
    public <E2 extends Exception> Result<V, E> recover(Class<E2> eClass, Supplier<V> recovery) {
    ...
    public <E2 extends Exception> V orElseThrowAs(Function<E, E2> emapper) throws E2 {
        return Optional.ofNullable(value).orElseThrow(() -> emapper.apply(error));
    }

    public V orElseAssert() {
        return orElseThrowAs(IllegalArgumentException::new);
    }
